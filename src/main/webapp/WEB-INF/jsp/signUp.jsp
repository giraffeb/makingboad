    ...
    <div id="sign_up_area">
        <form action="signup" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <div class="form-group row">
                ...
                <small id="id_help" class="col-sm-6 form-text text-muted">알파벳 소문자, 숫자포함 4~15자로 설정해주세요.</small>
            ...
            <div class="form-group row">
                ...
                <small id="password_help" class="col-sm-6 form-text text-muted">알파벳 소문자, 특수문자, 숫자포함 4~15자로 설정해주세요.</small>
